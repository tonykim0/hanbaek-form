...
- **포털** (`app/(portal)/`, 로그인 없음) — 협력사의 입구. 운영사별 계약서를 자동으로 채워
  만든다(플러그링크·나이스인프라·현대엔지니어링·SK·자체투자). 자료실·이력조회·단지조회도 여기다.
  **접수는 2026-08-26 에 닫았다** — 작성한 서류는 콘솔에서 낸다(`/intake` 는 그리로 보내는 안내).
...
**노션 병행 → 콘솔 픽스 → 노션 이관(2026-08-24)·접수 컷오버(2026-08-26) → 콘솔로 일원화.**
접수까지 콘솔로 넘어왔다. 그 뒤에도 포털은 협력사의 로그인 없는 입구(계약서 작성·자료실·조회)로
남는다. 자세한 단계와 작업 규칙은 `CLAUDE.md`.
