 ...
 *
 * ★나이스의 하반기 시작은 8월 1일 접수분이다 — 「하반기 = 7월 1일」이 아니다★
 * (한백 확인 2026-09-04 「하반기랑 8월 1일이랑 같은 거」). 7월 1일짜리 케이스 둘
 * (nice-h2-y7/y10-mother-new-apt — 금액이 상반기 그대로인 자리 지킴)이 시드 정리(8/22)
 * 뒤에도 프로덕션에 남아 매트릭스에 세 겹으로 섰다 — 2026-09-04 걷어냈다. 7월 접수
 * 계약은 상반기(1/27) 케이스의 이월이 맞다. 한전불입 7년은 ★원래 없다★(한백 확인).
 *
 ...
 *
 * ★연동은 이 파일에 없다.★ 정책 배포본이 보조사업·투자사업 두 표뿐이라 연동 항목이
 * 아예 없었다. 연동 케이스 한 건(받는 단가 90만 · 7·10년 한 칸)은 한백 지시로 따로
 * 들어갔고 근거는 migrations/0045 다 — 이 파일이 나이스 전부가 아니다.
 *
