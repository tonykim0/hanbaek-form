...
export const STATUS_GATES: Record<ProcessStatus, StatusGate | null> = {
   ...
   * 지킨다(승인일·착공일) — 이 칸만은 우리 선언이라 지킬 바깥 사실이 없다.
  ...
  '행위신고': null,
  /*
   * 승인일과 행위신고 완료 체크 — 둘 다 있어야 한다 (승인일 한 칸이 환경부 승인과
   * 운영사 시공승인을 겸한다, 한백 2026-08-27).
  ...
  '충전기 발주': {
     ...
     */
    /*
     * 승인일 한 칸이 환경부 승인과 운영사 시공승인을 겸한다 (한백 2026-08-27) —
 ...
 *   승인일 — 환경부·운영사가 한백에 통보하는 값이다(한 칸이 둘을 겸한다, 2026-08-27).
 ...
 * 됐는데 승인일이 없음) 체크만 남고, 조건이 차면 보드 카드의 넘기기가 민다.
 */
