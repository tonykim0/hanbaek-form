 ...
 * 실제로 「계약완료」에서 한 번 겪고 고쳤는데 「설치완료」가 그대로 남아 있었다 —
 * 그쪽은 문구가 아니라 칸 이름을 갈아 「개통 및 통신확인」이 됐다(한백 지시 2026-09-04).
 */
...
describe('칸 이름이 곧 시킬 일인 자리는 그대로 쓴다', () => {
  ...
  it.each([
    '행위신고', '충전기 발주', '충전기 수령', '착공',
    /* 「설치완료」였다 — 문구를 갈지 않고 칸 이름을 갈았다(한백 지시 2026-09-04) */
    '개통 및 통신확인', '준공보완',
  ] as const)(
    '%s',
