...
export const PROCESS_STATUSES = [
  ...
  '계약완료',
  /*
   * 우리가 운영사에게 계약서를 냈고 승인을 기다리는 자리.
   *
   * ★이 칸이 없으면 안 낸 현장과 낸 현장이 같은 칸에 있다.★ 계약완료 다음이 곧바로
   * 「시공진행필요」였는데 그건 운영사가 승인했다는 뜻이다. 우리가 언제 냈는지, 냈는지조차
   * 남는 자리가 없어서 「이 현장 운영사에 냈나?」를 물어봐야 알 수 있었다.
   */
  '운영사 제출',
  '시공진행필요',
  '설치완료',
...
export interface ProcessInfo {
  ...
  /**
   * 운영사에 계약서를 낸 날. 「운영사 제출」로 넘어가는 근거다.
